...
class JazzCashWebView2 extends StatefulWidget {
  const JazzCashWebView2({Key? key, required this.bookindData})
      : super(key: key);
  final AdvancePendingResponse bookindData;

  @override
  _JazzCashWebView2State createState() => _JazzCashWebView2State();
}

class _JazzCashWebView2State extends State<JazzCashWebView2> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse(
            'https://${Api.baseURLForJazzCash}experience-booking/confirm-booking/${widget.bookindData.t.id}'),
        headers: {
