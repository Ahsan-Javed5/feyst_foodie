...
class _$Initialized implements Initialized {
  ...
  @override
  String toString() {
    return 'LoginScreenState.initialized(appVersion: $appVersion, email: $email, password: $password, baseURL: $baseURL, baseUrlIndex: $baseUrlIndex, isBusy: $isBusy, rememberMe: $rememberMe, errorMessage: $errorMessage)';
  }
