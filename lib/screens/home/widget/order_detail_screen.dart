...
class OrderDetailScreen extends StatefulWidget {
  const OrderDetailScreen({super.key, this.data, required this.scheduleModel});
              ...
              SizedBox(
                ...
                child: GeneralButton.button(
                  ...
                  onTap: () {
                    ...
                    final _foodDetailViewModel =
                        locateService<FoodProductExperienceDetailsViewModel>();
                    OrderHelper orderHelper = (_appService.state.orderHelper)!;
                    orderHelper.selectedExperienceDetail = widget.data!;
                    orderHelper.selectedPreferenceId = 1;
                    orderHelper.scheduleId = widget
                        .scheduleModel.t.daysGroups[0].hours[0].scheduleId
                        .toString();
                    orderHelper.numberOfPerson = 1;
                    ...
                    _storage.readString(key: 'auth_token').isEmpty
                        ? loginDialog(
                            ...
                            onTap: () {})
                        : _foodDetailViewModel.submitBooking(
                            context, widget.data!);
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GeneralText(
                ...
                '${Strings.rupeesLabel} ${widget.data?.price}',
                style: appTheme.typographies.interFontFamily.headline6.copyWith(
                  fontSize: 17,
                  fontWeight: FontWeight.w600,
                  color: HexColor.fromHex('#ffffff'),
          ...
          Row(
            ...
            children: [
              ...
              GeneralText(
                // Strings.productDetailPriceTaxValue,
                '${Strings.rupeesLabel} ${(widget.data?.price)?.toStringAsFixed(0)}',
                style: appTheme.typographies.interFontFamily.headline6.copyWith(
                  fontSize: 15,
                  color: HexColor.fromHex('#b9b7ba'),
                ),
