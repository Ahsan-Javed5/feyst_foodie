...
class _$InitializedImpl implements Initialized {
  ...
  @override
  String toString() {
    return 'EditProfileScreenState.initialized(mobileNumber: $mobileNumber, isBusy: $isBusy, errorMessage: $errorMessage)';
  }
...
abstract class Initialized implements EditProfileScreenState {
