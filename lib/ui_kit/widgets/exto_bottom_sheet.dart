...
import 'package:chef/ui_kit/widgets/exto_bottom_sheet_item.dart';
...
class ExtoBottomSheet<T> extends StatefulWidget {
  const ExtoBottomSheet({
  ...
  @override
  State<ExtoBottomSheet<T>> createState() => _ExtoBottomSheetState<T>();
}

class _ExtoBottomSheetState<T> extends State<ExtoBottomSheet<T>> {
