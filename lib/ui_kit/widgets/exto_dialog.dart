...
class ExtoDialog extends StatelessWidget {
  ExtoDialog({
    required ExtoComponentStyle dialogStyle,
    String? title,
    Widget? header,
    Widget? body,
    Widget? image,
  ...
  final ExtoComponentStyle _dialogStyle;
