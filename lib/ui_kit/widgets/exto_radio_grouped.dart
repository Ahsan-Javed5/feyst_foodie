...
import 'package:chef/ui_kit/widgets/exto_radio.dart';
...
class ExtoRadioGroup<T> extends ExtoFieldBase<T> {
  ExtoRadioGroup({
...
class _ExtoRadioGroupState<T> extends ExtoFieldState<ExtoRadioGroup<T>, T> {}
